...
# 一个 get 的spider 配置详情页 解析
class CommonGetXpathSpiderRedis(RedisCrawlSpider):
    name = "common_get_xpath_redis"
    redis_key = "common_get_xpath_redis:start_urls"
    def __init__(self, name, *args, **kwargs):
        ...
        super(CommonGetXpathSpiderRedis, self).__init__(*args, **kwargs)
